...
public class PreProcessClusterInput {
  ...
  private static void printUsageMsg() {
    System.out.println(
        "Please specify an input directory of CSV files to pre process and output path.");
    System.out.println(
        "USAGE: PreProcessClusterInput --schema=\"<comma list of featureName:<ID | GEO | LABEL | CC | NUMBER | CATEGORY>>\" --inputdir=\"<INPUT DIR>\" --ouputdir=\"<OUTPUT DIR>\"");
    System.out.println(
        "EXAMPLE:  PreProcessClusterInput --schema=\"entityType:CATEGORY,location:GEO,name:LABEL,avgTrns:NUMBER\" --inputdir=\"rawinput\" --outputdir=\"instances\"");
  }
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      if (inputDir == null || outputDir == null || schema == null)
