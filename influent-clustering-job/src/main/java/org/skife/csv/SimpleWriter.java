...
public class SimpleWriter implements CSVWriter {
  ...
  /**
   * Create a CSVWriter which prints output to a <code>Writer</code>. It does not close the Writer.
   */
   ...
   *
   * @throws RuntimeException if there is an exception during execution, flushing, or closing the
   *     file
   */
