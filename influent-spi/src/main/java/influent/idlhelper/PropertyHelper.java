...
public class PropertyHelper extends FL_Property {
  ...
  public PropertyHelper(String key, Object value, List<FL_PropertyTag> tags) {
    setKey(key);
  ...
  public PropertyHelper(String key, Object value, List<FL_PropertyTag> tags, Boolean isHidden) {
    setKey(key);
    setFriendlyText(key.replaceAll("([a-z])([A-Z0-9])", "$1 $2").replace('_', ' '));
    setProvenance(null);
    setUncertainty(null);
  ...
  public PropertyHelper(String key, String friendlyText, Object value, List<FL_PropertyTag> tags) {
    setKey(key);
    setFriendlyText(friendlyText);
    setProvenance(null);
    setUncertainty(null);
  ...
  public PropertyHelper(
      String key, String friendlyText, Object value, List<FL_PropertyTag> tags, boolean isHidden) {
    setKey(key);
    setFriendlyText(friendlyText);
    setProvenance(null);
    setUncertainty(null);
  ...
  public PropertyHelper(String key, Object value, FL_PropertyTag tag, Boolean isHidden) {
    this(key, value, Collections.singletonList(tag), isHidden);
  }

  public PropertyHelper(
      String key, String friendlyText, Object value, FL_PropertyType type, FL_PropertyTag tag) {
    setKey(key);
    setFriendlyText(friendlyText);
    setProvenance(null);
    setUncertainty(null);
  ...
  public PropertyHelper(
      String key, String friendlyText, String value, List<FL_PropertyTag> tags, Boolean isHidden) {
    this(key, friendlyText, value, FL_PropertyType.STRING, tags, isHidden);
  }

  public PropertyHelper(
      String key, String friendlyText, double value, List<FL_PropertyTag> tags, Boolean isHidden) {
    this(key, friendlyText, value, FL_PropertyType.DOUBLE, tags, isHidden);
  }

  public PropertyHelper(
      String key, String friendlyText, Date date, List<FL_PropertyTag> tags, Boolean isHidden) {
    this(
        key, friendlyText, date != null ? date.getTime() : 0, FL_PropertyType.DATE, tags, isHidden);
  }

  public PropertyHelper(
      String key, String friendlyText, long value, List<FL_PropertyTag> tags, Boolean isHidden) {
    this(key, friendlyText, value, FL_PropertyType.LONG, tags, isHidden);
  }

  public PropertyHelper(
      String key, String friendlyText, int value, List<FL_PropertyTag> tags, Boolean isHidden) {
  ...
  public static Object getValueByUnmappedKey(
      String key, List<FL_Property> props, List<FL_PropertyDescriptor> defns, String type) {
  ...
  public FL_PropertyType getType() {
    ...
    if (range instanceof FL_SingletonRange) return ((FL_SingletonRange) range).getType();
    else if (range instanceof FL_ListRange) return ((FL_ListRange) range).getType();
    else if (range instanceof FL_BoundedRange) return ((FL_BoundedRange) range).getType();
    else if (range instanceof FL_DistributionRange) return ((FL_DistributionRange) range).getType();
    return null;
  }
