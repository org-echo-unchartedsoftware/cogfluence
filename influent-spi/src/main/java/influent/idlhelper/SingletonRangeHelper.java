...
public class SingletonRangeHelper {
  ...
  /**
   * Class construction should really be deprecated for use of these methods when the type is known
   * at compile time.
   *
   * @param value
  ...
  public static FL_SingletonRange from(String value) {
    return FL_SingletonRange.newBuilder().setType(FL_PropertyType.STRING).setValue(value).build();
  }
  ...
  public static FL_SingletonRange from(Boolean value) {
    return FL_SingletonRange.newBuilder().setType(FL_PropertyType.BOOLEAN).setValue(value).build();
  }
  ...
  public static FL_SingletonRange from(Integer value) {
    return FL_SingletonRange.newBuilder().setType(FL_PropertyType.INTEGER).setValue(value).build();
  }
  ...
  public static FL_SingletonRange from(Long value) {
    return FL_SingletonRange.newBuilder().setType(FL_PropertyType.LONG).setValue(value).build();
  }
  ...
  public static FL_SingletonRange from(Double value) {
    return FL_SingletonRange.newBuilder().setType(FL_PropertyType.DOUBLE).setValue(value).build();
  }
  ...
  public static FL_SingletonRange from(FL_GeoData value) {
    return FL_SingletonRange.newBuilder().setType(FL_PropertyType.GEO).setValue(value).build();
  }
  ...
  public static FL_SingletonRange from(Object value, FL_PropertyType type) {
    return FL_SingletonRange.newBuilder().setType(type).setValue(value).build();
  }

  /**
   * Do a best guess determination of type. Note that if the value is null the property type is
   * indeterminant and will be marked as OTHER.
   *
   * @param untyped value
