...
public class EntityHelper extends FL_Entity {
  ...
  public EntityHelper(
      String id,
      String type,
      List<FL_EntityTag> tagList,
      FL_Provenance provenance,
      FL_Uncertainty uncertainty,
      List<FL_Property> properties) {
    super(
        id,
        type,
        new ArrayList<FL_EntityTag>(tagList),
        provenance,
        uncertainty,
        new ArrayList<FL_Property>(properties));
  }

  public EntityHelper(
      String id, String type, List<FL_EntityTag> tagList, List<FL_Property> properties) {
    this(
        id,
        type,
        tagList,
        ...
        merge(
            properties,
            Arrays.asList(new FL_Property[] {new PropertyHelper(FL_PropertyTag.TYPE, type)})));
  }
  ...
  public EntityHelper(
      String id, String label, String type, FL_EntityTag tag, List<FL_Property> properties) {
  ...
  public static Object getValueByUnmappedKey(
      FL_Entity link, String key, List<FL_PropertyDescriptor> defns) {
    return PropertyHelper.getValue(getPropertyByUnmappedKey(link, key, defns));
  }

  public static FL_Property getPropertyByUnmappedKey(
      FL_Entity entity, String key, List<FL_PropertyDescriptor> defns) {
