...
public class SerializationHelper {
  ...
  public static <T extends SpecificRecord> String toJson(List<T> list, Schema schema)
      throws IOException {
    ByteArrayOutputStream bos = new ByteArrayOutputStream();
  ...
  public static <T extends SpecificRecord> String toJson(Map<String, List<T>> map, Schema schema)
      throws IOException {
    ByteArrayOutputStream bos = new ByteArrayOutputStream();
    Encoder encoder =
        EncoderFactory.get().jsonEncoder(Schema.createMap(Schema.createArray(schema)), bos);

    DatumWriter<Map<String, List<T>>> writer =
        new SpecificDatumWriter<Map<String, List<T>>>(Schema.createMap(Schema.createArray(schema)));
  ...
  public static <T extends SpecificRecord> T fromJson(String json, Schema schema)
      throws IOException {
  ...
  public static <T extends SpecificRecord> List<T> listFromJson(String json, Schema schema)
      throws IOException {
    ByteArrayInputStream bis = new ByteArrayInputStream(json.getBytes("utf-8"));
  ...
  public static <T extends SpecificRecord> Map<String, List<T>> mapFromJson(
      String json, Schema schema) throws IOException {
    ByteArrayInputStream bis = new ByteArrayInputStream(json.getBytes("utf-8"));
    Decoder decoder =
        DecoderFactory.get().jsonDecoder(Schema.createMap(Schema.createArray(schema)), bis);
    DatumReader<Map<String, List<T>>> datumReader =
        new SpecificDatumReader<Map<String, List<T>>>(Schema.createMap(Schema.createArray(schema)));
