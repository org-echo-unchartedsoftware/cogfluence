...
public class PropertyDescriptorHelper extends FL_PropertyDescriptor {
  ...
  public static Map<String, List<FL_PropertyDescriptor>> mapFromJson(String json)
      throws IOException {
  ...
  public static FL_PropertyDescriptor findByMemberKey(
      String key, List<FL_PropertyDescriptor> list) {
    if (key != null) {
      for (FL_PropertyDescriptor pd : list) {
  ...
  public static List<FL_PropertyDescriptor> findByTag(
      FL_PropertyTag tag, List<FL_PropertyDescriptor> list) {
  ...
  public static FL_PropertyDescriptor findFirstByTag(
      FL_PropertyTag tag, List<FL_PropertyDescriptor> list) {
  ...
  public static List<String> mapKeys(
      String key, List<FL_PropertyDescriptor> defns, Set<String> types) {
  ...
  public static List<FL_OrderBy> mapOrderBy(
      List<FL_OrderBy> orderBy, List<FL_PropertyDescriptor> descriptors, String type) {
    return mapOrderBy(orderBy, descriptors, Collections.singleton(type));
  }

  public static List<FL_OrderBy> mapOrderBy(
      List<FL_OrderBy> orderBy, List<FL_PropertyDescriptor> descriptors, Set<String> types) {
