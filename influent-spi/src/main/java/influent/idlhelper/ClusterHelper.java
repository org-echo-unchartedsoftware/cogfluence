...
public class ClusterHelper extends FL_Cluster {
  public ClusterHelper(
      ...
      List<java.lang.String> members,
      List<java.lang.String> subclusters,
      String parent,
      String root,
      Integer level) {
    super(
        ...
        new ArrayList<String>(members),
        new ArrayList<String>(subclusters),
        parent,
        root,
        level,
        1);
    ...
    this(
        ...
        merge(
            ...
            Collections.singletonList(
                (FL_Property) new PropertyHelper(FL_PropertyTag.LABEL, label))),
        members,
        subclusters,
        parent,
        root,
