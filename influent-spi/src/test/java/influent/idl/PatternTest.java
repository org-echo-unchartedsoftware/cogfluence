...
public class PatternTest {
  ...
  public void obfuscatedMoneyFlow() throws IOException {
    ...
    FL_EntityMatchDescriptor.Builder entityBuilder =
        FL_EntityMatchDescriptor.newBuilder().setProperties(null).setTags(null);

    FL_EntityMatchDescriptor person1 =
        entityBuilder
    ...
    FL_EntityMatchDescriptor person2 =
        entityBuilder
            .setUid(UUID.randomUUID().toString())
            .setRole("Person 2")
            .setConstraint(null)
    ...
    FL_EntityMatchDescriptor person3 =
        entityBuilder
            .setUid(UUID.randomUUID().toString())
            .setRole("Person 3")
            .setConstraint(null)
    ...
    FL_EntityMatchDescriptor person4 =
        entityBuilder
            .setUid(UUID.randomUUID().toString())
            .setRole("Person 4")
            .setConstraint(null)
    ...
    FL_EntityMatchDescriptor person5 =
        entityBuilder
            .setUid(UUID.randomUUID().toString())
            .setRole("Person 5")
            .setConstraint(null)
    ...
    FL_PropertyMatchDescriptor amountEquals =
    ...
    FL_PropertyMatchDescriptor amountLessThan =
        FL_PropertyMatchDescriptor.newBuilder()
            .setKey(FL_PropertyTag.AMOUNT.name())
            .setConstraint(null)
            .setRange(SingletonRangeHelper.from(X))
    ...
    FL_LinkMatchDescriptor.Builder linkBuilder =
        FL_LinkMatchDescriptor.newBuilder().setLinkTypes(null).setRole(null).setConstraint(null);

    FL_LinkMatchDescriptor link12 =
        linkBuilder
            .setUid(UUID.randomUUID().toString())
    ...
    FL_PatternDescriptor descriptor =
        FL_PatternDescriptor.newBuilder()
            .setUid(UUID.randomUUID().toString())
