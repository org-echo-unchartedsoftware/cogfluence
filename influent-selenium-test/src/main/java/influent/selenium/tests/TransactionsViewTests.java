...
public class TransactionsViewTests extends BrowserParameterizedTest {
  ...
  public TransactionsViewTests(BROWSER browser) {
    super(browser);
  }
  ;
  ...
  public void searchTest() {
    ...
    // Test selection
    List<WebElement> switchViewButtons =
        resultsRoot.findElements(By.cssSelector("#infLinkSearchResultOpBar [switchesto]"));
    ...
    WebElement firstAccountsResult =
        (new WebDriverWait(driver, 120))
            .until(
                ExpectedConditions.presenceOfElementLocated(By.cssSelector(".selectSingleResult")));
    ...
    elements =
        driver.findElements(
            (By.cssSelector("#infAccountSearchResultContainer .simpleSearchResultText")));
    element = SeleniumUtils.getDisplayedElement(elements);
    assertEquals(
