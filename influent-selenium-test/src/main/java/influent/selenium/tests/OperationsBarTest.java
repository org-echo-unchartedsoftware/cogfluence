...
public class OperationsBarTest extends BrowserParameterizedTest {
  ...
  public OperationsBarTest(BROWSER browser) {
    super(browser);
  }
  ;
  ...
  public void accountsToTransactionsTest() {
    ...
    if (switchToTransactionsButton == null) {
      throw new AssertionError(
          "Couldn't find: Button to switch to transactions view in infOperationsBar");
    }
    ...
    WebElement firstTransactionResult =
        (new WebDriverWait(driver, Duration.ofSeconds(120)))
            .until(
                ExpectedConditions.presenceOfElementLocated(
                    By.cssSelector(".transactionsSearchResult")));
  ...
  public void accountsToFlowTest() {
    ...
    WebElement firstTransactionResult =
        (new WebDriverWait(driver, Duration.ofSeconds(120)))
            .until(
                ExpectedConditions.presenceOfElementLocated(By.cssSelector(".insideBaseballCard")));
    if (firstTransactionResult == null) {
      throw new AssertionError(
          "Couldn't find any transaction results.   Either timed out or search returned no transactions!");
    }
  ...
  public void transactionsToAccountsTest() {
    ...
    if (switchToAccountsButton == null) {
      throw new AssertionError(
          "Couldn't find: Button to switch to accounts view in infOperationsBar");
    }
    ...
    WebElement firstTransactionResult =
        (new WebDriverWait(driver, Duration.ofSeconds(120)))
            .until(
                ExpectedConditions.presenceOfElementLocated(
                    By.cssSelector(".accountsSearchResult")));
    if (firstTransactionResult == null) {
      throw new AssertionError(
          "Couldn't find any transaction results.   Either timed out or search returned no transactions!");
    }
