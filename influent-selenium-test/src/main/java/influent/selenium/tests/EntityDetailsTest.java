...
public class EntityDetailsTest extends BrowserParameterizedTest {
  ...
  public EntityDetailsTest(BROWSER browser) {
    super(browser);
  }
  ;
  ...
  public void accountsViewButtonTest() {
    ...
    element =
        (new WebDriverWait(driver, Duration.ofSeconds(120)))
            .until(
                ExpectedConditions.presenceOfElementLocated(By.className("infSearchResultCounts")));
  ...
  public void entityDetailsTest() {
    ...
    assertEquals(
        "http://localhost:8080/kiva/rest/icon/aperture-hscb/Person?iconWidth=32&iconHeight=32",
        src);
  ...
  public void clusterSummaryDetailsTest() {
    ...
    String src = element.getAttribute("src");
    assertEquals(
        "http://localhost:8080/kiva/rest/icon/aperture-hscb/Organization?iconWidth=32&iconHeight=32&role=business",
        src);
