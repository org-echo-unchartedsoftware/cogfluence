...
public class SeleniumUtils {
  ...
  public static void loginToInfluent(WebDriver driver, String username, String password) {
    try {
  ...
  public static void navigateToTab(WebDriver driver, String id) {
   ...
   *
   * @return Returns true if the element has the specified class. False otherwise.
   */
   ...
   *
   * @param elements the list of given elements
   * @return the first element that is being displayed from the list of given elements
   */
  public static WebElement getDisplayedElement(List<WebElement> elements) {
