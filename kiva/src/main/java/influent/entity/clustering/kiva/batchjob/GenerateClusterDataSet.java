...
public class GenerateClusterDataSet {
  ...
  public static void writeEntitiesToFile(ResultSet rs, String outputPath)
  ...
  public static void main(String[] args) {
    try {
      ...
      SQLConnectionPool connection =
          new BoneCPConnectionPool(serverName, portNumber, databaseName, username, password, null);

      // Create Borrowers Dataset
      String sql =
          "SELECT 'borrower' as type, 'b' + CONVERT(nvarchar, loans_id) as id, loans_name as label, loans_location_countryCode as countrycode, lat, lon FROM loanMetaData";
      ...
      sql =
          "SELECT 'lender' as type, 'l' + lenders_lenderid as id, lenders_name as label, lenders_countryCode as countrycode, lat, lon FROM lenders";
      ...
      sql =
          "SELECT 'broker' as type, b.entityId as id, partners_name as label, partners_countries_isoCode as countryCode, lat, lon ";
