...
/**
 * This class is used by the Kiva *server* implementation. It binds the new FL_ implementation for
 * that server.
 */
public class KivaFLDataAccessModule extends AbstractModule {
  ...
  public KivaDataAccess connect(
    ...
    try {
      return new KivaDataAccess(config, connectionPool, search, namespaceHandler, sqlBuilder);
    } catch (Exception e) {
