  ...
  public Map<String, List<FL_Entity>> getAccounts(List<String> entities)
    ...
    try {
      ...
      String partnerBrokersTable =
          _applicationConfiguration.getTable("PartnerBrokers", "PartnerBrokers");
      String brokerColumn = _applicationConfiguration.getColumn("PartnerBrokers", "BrokerEntityId");
      String partnerColumn =
          _applicationConfiguration.getColumn("PartnerBrokers", "PartnerEntityId");
      ...
      String sql =
          "SELECT "
              ...
              + partnerColumn
              + " IN "
              + DataAccessHelper.createInClause(ns_entities);
      ...
      for (FL_Entity entity : getEntities(accounts, FL_LevelOfDetail.SUMMARY)) {
        String ownerId =
            InfluentId.ACCOUNT_OWNER
                + "."
                + (String)
                    EntityHelper.getFirstPropertyByTag(entity, FL_PropertyTag.ACCOUNT_OWNER)
                        .getValue();
