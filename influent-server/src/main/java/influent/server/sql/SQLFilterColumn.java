...
public interface SQLFilterColumn extends SQLFilter {
   ...
   *
   * @param name A column from the selected table
   * @return
   */
   ...
   *
   * @param val The value to compare to. A {@link LazyNamedParam} can also be used here, and will
   *     allow the value to be replaced later.
   * @return
   */
   ...
   *
   * @param regex The value to use in the SQL statement. A {@link LazyNamedParam} can also be used
   ...
   *
   * @param val A list of values that will be stringified to be used as parameters to the 'IN'
   *     clause. {@link LazyNamedParam}s can also be used here, and will allow values to be replaced
   *     later.
   * @return
   */
   ...
   *
   * @param val1 The lower bounds value for the column. {@link LazyNamedParam}s can also be used
   *     here, and will allow values to be replaced later.
   * @param val2 The upper bounds value for the column. {@link LazyNamedParam}s can also be used
   *     here, and will allow values to be replaced later.
   * @return
   */
