...
public class LabelEntityClusterer extends BaseEntityClusterer {
  ...
  private ClusterContext clusterByEditDistance(
  ...
  public ClusterContext clusterEntities(
    ...
    ClusterContext modifiedClusters =
        super.clusterEntities(entities, immutableClusters, clusters, context);
    ...
    if (totalClusters > K) { // more than max clusters generated - merge clusters
      modifiedClusters =
          clusterByEditDistance(entities, immutableClusters, newClusters, clusters, context);
    }
