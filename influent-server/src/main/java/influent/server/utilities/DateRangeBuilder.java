...
public class DateRangeBuilder {
  ...
  public static FL_DateRange getDateRange(DateTime startDate, DateTime endDate) {
    ...
    //		if (days.getDays() == 30) { return new ConstrainedDateRange(startDate, FL_DateInterval.DAYS,
    // 15L, 2); }
    //		if (days.getDays() == 60) { return new ConstrainedDateRange(startDate, FL_DateInterval.DAYS,
    // 15L, 4); }
    ...
    //		if (weeks.getWeeks() == 32) { return new ConstrainedDateRange(startDate,
    // FL_DateInterval.WEEKS, 16L, 2); }
    ...
    //		if (months.getMonths() == 24) { return new ConstrainedDateRange(startDate,
    // FL_DateInterval.MONTHS, 16L, 2); }
    ...
    //		if (years.getYears() == 8) { return new ConstrainedDateRange(startDate,
    // FL_DateInterval.QUARTERS, 16L, 2); }
  ...
  public static int determineInterval(
      DateTime date, DateTime startDate, FL_DateInterval interval, int numIntervalsPerBin) {
    switch (interval) {
      case SECONDS:
