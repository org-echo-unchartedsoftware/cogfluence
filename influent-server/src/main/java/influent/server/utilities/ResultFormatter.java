...
public class ResultFormatter {
  ...
  public static String formatCur(Number d, boolean isUSD) {
    return d == null ? "-" : isUSD ? us_df.format(d) : world_df.format(d);
  }

  public static String formatCount(Number d) {
    return d == null ? "-" : world_if.format(d);
  }
