...
/**
 * Native ids are typed for internal reference to make it easy to distinguish between entity types,
 * like accounts or clusters.
 *
 * @author djonker
 */
public final class InfluentId {
  ...
  public static final char ACCOUNT_OWNER = 'o';

  /** The cluster id type. */
  public static final char CLUSTER = 'c';

  /** The cluster summary id type. */
  public static final char CLUSTER_SUMMARY = 's';
  ...
  public static InfluentId fromNativeId(
      final char idClass, final String idType, final String nativeId) {
  ...
  /**
   * Converts a list of influent ids to native ids, filtering for the specified class and returning
   * a new list.
   */
  public static List<String> nativeFromInfluentIds(
      final Collection<String> influentIds, final char filterClass) {
    final List<String> list = new ArrayList<String>(influentIds.size());
  ...
  /**
   * Converts a list of influent ids to typed ids, filtering for the specified class and returning a
   * new list.
   */
  public static List<String> typedFromInfluentIds(
      final Collection<String> influentIds, final char filterClass) {
    final List<String> list = new ArrayList<String>(influentIds.size());
  ...
  public static List<String> filterInfluentIds(
      final Collection<String> influentIds, final char filterClass) {
    final List<String> list = new ArrayList<String>(influentIds.size());
  ...
  public static List<String> filterTypedIds(
      final Collection<String> influentIds, final char filterClass) {
    final List<String> list = new ArrayList<String>(influentIds.size());
  ...
  public static List<String> influentFromNativeIds(
      char idClass, String idType, final Collection<String> nativeIds) {
