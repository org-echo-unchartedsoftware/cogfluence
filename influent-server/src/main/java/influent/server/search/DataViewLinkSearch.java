...
public class DataViewLinkSearch implements FL_LinkSearch {
  ...
  public DataViewLinkSearch(
    ...
    _sqlHelper =
        new SearchSQLHelper(_sqlBuilder, _connectionPool, _applicationConfiguration, FL_Link.class);
  }
  ...
  protected FL_Link createLink(
      String uid, String from, String to, String type, List<FL_Property> props) {
  ...
  public FL_PropertyDescriptors getKeyDescriptors(
    ...
    if (!props.isEmpty()) {
      ...
      if (keyFields.isEmpty()) {
        addIfNotNull(
            keyFields, PropertyDescriptorHelper.find(FL_RequiredPropertyKey.FROM.name(), props));
        addIfNotNull(
            keyFields, PropertyDescriptorHelper.find(FL_RequiredPropertyKey.TO.name(), props));
        addIfNotNull(
            keyFields, PropertyDescriptorHelper.find(FL_RequiredPropertyKey.DATE.name(), props));
        addIfNotNull(
            keyFields, PropertyDescriptorHelper.find(FL_RequiredPropertyKey.AMOUNT.name(), props));
      }
