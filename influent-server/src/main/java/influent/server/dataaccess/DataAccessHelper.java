...
public class DataAccessHelper {
  ...
  public static final String ENTITY_COLUMN_UNIQUE_OUTBOUND_DEGREE =
      "FinEntity_UniqueOutboundDegree";
  ...
  // Serves no purpose other than for us to identify popup requests down the line when we are
  // looking up entities.
  ...
  public static String linkEntityTypeClause(
      FL_DirectionFilter direction, FL_LinkEntityTypeFilter entityType) {
