...
public class ExportGraphResource extends ApertureServerResource {
  ...
  public ExportGraphResource(
      ExportDataService service, @Named("influent.charts.maxage") Integer maxCacheAge) {
  ...
  public Representation getCapturedImage(String jsonData) throws ResourceException {
    ...
    try {
      ...
      getResponse()
          .setCacheDirectives(Collections.singletonList(CacheDirective.maxAge(maxCacheAge)));
  ...
  private Representation executeTask(JSONObject data)
