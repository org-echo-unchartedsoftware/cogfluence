...
public class DataTableSchema {
  private String _key;
  private Map<String, DataTableProperty> _tableProperties =
      new HashMap<String, DataTableProperty>();
  private Map<String, DataColumnProperty> _columnProperties =
      new HashMap<String, DataColumnProperty>();
