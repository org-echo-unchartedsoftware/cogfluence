...
public class BasicCountryLevelGeocoding implements FL_Geocoding {
    ...
    if (inp != null) {
      try {
        ...
        for (int i = 0; i < array.length(); i++) {
          ...
          final FL_Country country =
              new ImmutableCountry(
  ...
  /**
   * Does a lookup for country data based on country code. Locations must be geocoded with country
