...
/**
 * Simple handler to marshal/unmarshal XML text in JAXB. This is necessary to ensure the XML text is
 * actually output as XML, as opposed to having &lt; and &gt; replacements everywhere.
 *
 * @author pmoore
 */
