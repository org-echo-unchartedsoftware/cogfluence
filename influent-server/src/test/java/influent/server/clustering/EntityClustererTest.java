...
public class EntityClustererTest {
  ...
  public void testClusterByLabelFingerprint() {
    ...
    assertClusterEquals(
        "c.cluster.4", "{c.cluster.4:[][c.cluster.5]}", context); // cluster by alpha "A"
    assertClusterEquals(
        "c.cluster.5",
  ...
  public void testClusterByLabelIncremental() {
    ...
    assertClusterEquals(
        "c.cluster.5",
        "{c.cluster.5:[][c.cluster.7,c.cluster.6]}",
  ...
  public void testClusterByGeoMultiLevel() {
    ...
    assertClusterEquals(
        "c.cluster.5", "{c.cluster.5:[][c.cluster.8,c.cluster.7,c.cluster.6]}", context); // CAN
